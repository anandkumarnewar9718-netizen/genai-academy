import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, f as composeRefs, g as reactDomExports, h as useComposedRefs, i as useLayoutEffect2, k as useCallbackRef$1, e as cn, R as React, v as vt, u as useParams, l as useNavigate, B as Button, d as BookOpen } from "./index-CdpgodV-.js";
import { X } from "./x-Xq3PhT2E.js";
import { S as Skeleton, T as Target } from "./skeleton-DPjjVmHm.js";
import { a as useGetCourse, b as useGetLessonsForCourse, e as useGetLesson, c as useGetMyProgress, f as useGetQuizForLesson, g as useMarkLessonComplete } from "./useBackend-BZbCDEVN.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      className: [
        ...
        isActive ? "bg-primary/10 text-primary font-medium" : "hover:bg-muted/60 text-foreground"
      ].join(" "),
      "aria-current": isActive ? "page" : void 0,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mt-0.5 shrink-0", children: isCompleted ? /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-5 h-5 text-accent" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
          Circle,
          {
            className: `w-5 h-5 ${isActive ? "text-primary" : "text-muted-foreground"}`
          }
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm leading-snug min-w-0 flex-1 break-words", children: lesson.title })
      ]
    }
  );
}
function SidebarPanel({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pt-4 pb-3 border-b border-border", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(GraduationCap, { className: "w-4 h-4 text-primary shrink-0" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground uppercase tracking-wider font-semibold", children: "Course" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-sm text-foreground leading-snug line-clamp-2", children: courseTitle })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "flex-1 px-2 py-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { "aria-label": "Lesson list", children: lessons.map((lesson, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      SidebarItem,
      {
        lesson,
        index: i + 1,
...
function LessonViewerPage() {
  ...
  const { data: lessons = [], isLoading: lessonsLoading } = useGetLessonsForCourse(courseId);
  ...
  const completedIds = new Set(
    ((progress == null ? void 0 : progress.completedLessons) ?? []).map((id) => id.toString())
  );
  const isCompleted = lessonId !== void 0 && completedIds.has(lessonId.toString());
  ...
  const hasQuiz = quiz !== null && quiz !== void 0;
  function goToLesson(lesson2) {
    setDrawerOpen(false);
    navigate({
      to: "/courses/$courseId/lessons/$lessonId",
      params: {
        courseId: lesson2.courseId.toString(),
        lessonId: lesson2.id.toString()
      }
    });
  }
  ...
  const sidebarContent = /* @__PURE__ */ jsxRuntimeExports.jsx(
    SidebarPanel,
    {
      courseTitle: (course == null ? void 0 : course.title) ?? "Loading...",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(InjectCodeStyles, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "aside",
            {
              ...
              children: lessonsLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 space-y-3", children: [1, 2, 3, 4, 5].map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-12 w-full rounded-xl" }, n)) }) : sidebarContent
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col flex-1 min-w-0 overflow-hidden", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:hidden flex items-center gap-3 px-4 py-3 border-b border-border bg-card shrink-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Sheet, { open: drawerOpen, onOpenChange: setDrawerOpen, children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(SheetContent, { side: "left", className: "w-80 p-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SheetHeader, { className: "sr-only", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SheetTitle, { children: "Lesson List" }) }),
                  lessonsLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 space-y-3", children: [1, 2, 3, 4, 5].map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-12 w-full rounded-xl" }, n)) }) : sidebarContent
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-semibold text-sm truncate text-foreground flex-1 min-w-0", children: (course == null ? void 0 : course.title) ?? "" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                ...
                ) : lesson ? /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  motion.article,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "mb-6", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground uppercase tracking-wider font-semibold", children: [
                            "Lesson ",
                          ...
                          isCompleted && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-auto flex items-center gap-1 text-xs font-medium text-accent", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-3.5 h-3.5" }),
                            "Completed"
                          ] })
                        ] }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl md:text-3xl font-bold text-foreground leading-tight", children: lesson.title })
                      ] }),
                      lesson.learningObjectives.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "section",
                        {
                          ...
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
                              ...
                              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-sm text-primary", children: "Learning Objectives" })
                            ] }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: lesson.learningObjectives.map((obj) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                              "li",
                              {
                                className: "flex items-start gap-2 text-sm text-foreground",
                                children: [
                                  /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-4 h-4 text-accent mt-0.5 shrink-0" }),
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "leading-snug", children: obj })
                                ]
                              },
                              obj
                            )) })
                  ...
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { className: "w-12 h-12 text-muted-foreground mb-4" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Lesson not found." })
                    ]
                  }
                )
              }
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 max-w-3xl mx-auto", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    Button,
                    {
                      variant: "outline",
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "Prev" })
                      ]
                    }
                  ),
                  !isCompleted ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    Button,
                    {
                      ...
                      children: [
                        markComplete.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "animate-spin w-4 h-4 border-2 border-primary-foreground border-t-transparent rounded-full" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-4 h-4" }),
                        "Mark as Complete"
                      ]
                    }
                  ) : hasQuiz ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    Button,
                    {
                      variant: "default",
